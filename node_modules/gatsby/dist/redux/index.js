...
var saveState = _.debounce(function (state) {
  var pickedState = _.pick(state, [`nodes`, `status`, `pageDataDependencies`]);
  fs.writeFile(`${process.cwd()}/.cache/redux-state.json`, (0, _stringify2.default)(pickedState, null, 2), function () {});
}, 1000);
