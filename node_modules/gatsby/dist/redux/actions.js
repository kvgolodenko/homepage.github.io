...
actions.createNode = function (node, plugin, traceId) {
  ...
  if (node.fields) {
    throw new Error(stripIndent`
      ...
      ${(0, _stringify2.default)(node, null, 4)}

      Plugin that created the node:

      ${(0, _stringify2.default)(plugin, null, 4)}
    `);
  }
...
actions.createNodeField = function (_ref, plugin, traceId) {
  ...
  var fieldOwner = node.internal.fieldOwners[fieldName];
 ...
 * @private
 */
actions.deletePagesDependencies = function (paths) {
  return {
 ...
 * @private
 */
actions.createPageComponent = function (componentPath) {
  return {
 ...
 * @private
 */
actions.replacePageComponentQuery = function (_ref4) {
