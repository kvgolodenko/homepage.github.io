      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            (), program = _store$getState.program, config = _store$getState.config, pages = _store$getState.pages;
            pagesData = pages.reduce(function (mem, _ref2) {
              ...
              return [].concat((0, _toConsumableArray3.default)(mem), [{ componentChunkName, layout, jsonName, path, matchPath }]);
            }, []
