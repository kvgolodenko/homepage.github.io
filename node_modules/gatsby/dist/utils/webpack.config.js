          ...
          case 0:
            ...
            resolve = function resolve() {
              ...
              return {
                ...
                // part of your site.
                modulesDirectories: [joinPath(directory, `node_modules`), `node_modules`, joinPath(directory, `node_modules`, `gatsby`, `node_modules`)]
              };
            };
            ...
            entry = function entry() {
              switch (stage) {
                case `develop`:
                  return {
                    commons: [require.resolve(`react-hot-loader/patch`), `${require.resolve(`webpack-hot-middleware/client`)}?path=http://${program.host}:${webpackPort}/__webpack_hmr&reload=true`, joinPath(directory, `.cache/app`)]
                  };
                case `build-css`:
                  return {
