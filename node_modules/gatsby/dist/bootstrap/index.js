      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 11:
            ...
            _context.next = 15;
            return Promise.all([md5File(`package.json`), Promise.resolve(md5File(`gatsby-config.js`).catch(function () {})), // ignore as this file isn't required),
            Promise.resolve(md5File(`gatsby-node.js`).catch(function () {}))]);
